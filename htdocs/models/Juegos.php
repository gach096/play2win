<?php
	class Juegos extends Model{
		...
		public function getJuegoByName($nombre){
			...
			if(is_numeric($nombre)) throw new ValidacionException("El nombre no puede ser un numero.");
		...
		public function getJuegoById($id){
			...
			*/
			if(!ctype_digit($id)) throw new ValidacionException('El ID de usuario contiene caracteres no validos.'); //die("noes num");
		...
		public function getActualizaciones($id){
			if(!is_numeric($id)) throw new ValidacionException('El ID de usuario contiene caracteres no validos.');
			if($id<=0) throw new ValidacionException('ID no valido');
