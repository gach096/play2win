	...
	class Database{
		...
		private function connect(){
			$this->cn=mysqli_connect(
        		...
        		'if0_42442061',       // ← usuario de BD
        		'*********',       // ← contraseña de BD (falsa por motivos de seguridad, modificar con contraseña real para que funcione)
        		'if0_42442061_play2win'    // ← nombre de la BD
    		);
            if(!$this->cn){
        		die("Error de conexión: " . mysqli_connect_error());
    		}else{
            	mysqli_set_charset($this->cn, "utf8mb4");
            }
		}
